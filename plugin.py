...
class BasePlugin:
    ...
    def __init__(self):
        ...
        self.debug = False
        self.setpoint = 21.0
        self.hyste = 10  # allowed deltamax from setpoint for high level airfan
    ...
    def onStart(self):
        ...
        if len(params) == 2:
            self.hyste = CheckParam("Hysterisis", params[0], 10)
    ...
    def onHeartbeat(self):
        ...
        if Devices[1].sValue == "0":  # Thermostat is off
            ...
            if self.intemp < self.setpoint :# we have a heating request
                ...
                Domoticz.Debug("heating mode : setpoint is reached")
                self.powerrequest = False
                if Devices[7].nValue == 1:
                   Devices[7].Update(nValue = 0,sValue = Devices[7].sValue)
